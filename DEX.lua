...
-- fixed domain
if not _G.FixedURL then
    _G.FixedURL = "https://setup.rbxcdn.com" 
    print("[+] configured domain :13:")
end
...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			rawAPI = rawAPI or oldgame:HttpGet(_G.FixedURL .. "/"..Main.RobloxVersion.."-API-Dump.json")
		else
	...
	Main.Init = function()
		...
		if Main.Elevated then
			...
			Main.RobloxVersion = Main.RobloxVersion or oldgame:HttpGet(_G.FixedURL .. "/".. "versionQTStudio")
		end
